...
def tokenize_text_from_file(file_path):
    with open(file_path, encoding="utf-8") as file:
        ...
        if not text.strip():
            ...
            return {"NON_WORD": 0}  # Return a dictionary with "NON_WORD" and 0 count
...
if __name__ == "__main__":
    ...
    text_files_directory = "../../data/output"
